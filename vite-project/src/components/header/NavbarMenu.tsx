    ...
    return (
        <>
            ...
            <nav id="sidebar" ref={navRef}>
                <button ref={burgerRef} className='header__menu-line hide-on-desktop nav-btn nav-close-btn burger' onClick={showNavBar}>
                ...
                <ul className="menu hide-on-desktop">
                    ...
                    <li className="menu-item menu-dropdown">
                        <button className="menu-button" onClick={(e) => toggleSubMenu(e.currentTarget)}>Sản phẩm
                    ...
                    <li className="menu-item menu-dropdown">
                        <button className="menu-button" onClick={(e) => toggleSubMenu(e.currentTarget)}>Giới thiệu
                            <span className="menu-arrow">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                    <path d="M12.7071 15.7251C12.3166 16.1156 11.6834 16.1156 11.2929 15.7251L6 10.4322L7.4 9.03223L12 13.6322L16.6 9.03223L18 10.4322L12.7071 15.7251Z" fill="currentColor"></path>
                                </svg>
